...
function templateBasketCalc() {
    ...
    <div class="basket-calc">
        ...
        <div class="basket-calc-right font">
            <span></span>${subTotal()} €<br><br>
            <span>${extraCost.toFixed(2)}</span> €<br>
            <h4><span>${total(subTotal(), extraCost)}</span> €</h4>
        </div>
    </div>
    <div class="paybutton"><h4>Bezahlen <span>(Placeholder €)</span></h4></div>
    `
}
